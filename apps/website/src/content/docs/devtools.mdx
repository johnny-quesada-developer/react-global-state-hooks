...
- Changing state is off until you enable "Allow the terminal to change state and run actions" in the panel under
  the gear, Terminal connection. Watching and reading never change the app.
