        ...
        {videos.map((item, index) => {
          ...
          return (
            <button
              ...
              key={item.id}
              id={tabId(item.id)}
              className="group relative flex cursor-pointer flex-col gap-0.5 border-x-0 border-t-2 border-b-0 border-line bg-transparent px-0 pt-2 pb-0 text-left font-sans text-base font-normal text-text-muted transition duration-150 ease-out hover:border-line-strong hover:text-text aria-selected:text-text"
