import { createContext, createGlobalState } from 'global-state-hooks-under-test';
import type { InferActionsType, InferStateApi, InferContextApi } from 'global-state-hooks-under-test';
