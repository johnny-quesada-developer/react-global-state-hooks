import { type StoreTools, Any, GlobalStore } from 'react-global-state-hooks';
import type { Mock } from 'vitest';

import $it from './$it';
// import { type StoreTools, GlobalStore } from 'react-global-state-hooks/GlobalStore';
...
describe('GlobalStore Basic', () => {
  ...
  $it('should notify initialize all subscribers of the store', ({ renderHook }) => {
    ...
    vi.spyOn(subscription1, 'onStoreChange');
    vi.spyOn(subscription2, 'onStoreChange');
